...
const daycarePropertiesSchema = new Schema({
    ...
    location_page: {type: String, default: true},
    impression_type: {type: String, default: true},
    channel_member_perms: {type: String, default: true},
    ...
    game_platform: {type: String, default: true},
